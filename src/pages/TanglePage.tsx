        ...
        <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md">
              ...
              <span className="text-sm font-medium">1 attempt = 3 stars</span>
            </div>
            <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md">
              <Award className="w-5 h-5 text-yellow-500" />
              <span className="text-sm font-medium">2 attempts = 2 stars</span>
            </div>
            <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md">
              <Award className="w-5 h-5 text-yellow-500" />
              <span className="text-sm font-medium">3 attempts = 1 star</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>5 minutes per level</span>
              </div>
              <div className="flex items-center space-x-1">
                <Triangle className="w-4 h-4" />
                <span>200 levels total</span>
              </div>
            </div>
          </div>
